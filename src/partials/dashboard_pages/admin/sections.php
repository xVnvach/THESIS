...
require_once __DIR__ . '/functions/func_sections.php';

?>
<div id="messageContainer"></div>
<section class="p-4 sm:p-6 bg-white rounded shadow-md overflow-x-auto">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
        <h1 class="text-lg sm:text-xl font-semibold mb-4 md:mb-0">Sections</h1>
        <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
            ...
            <div>
                <form method="GET" action="" class="flex">
                    ...
                    <input type="text" id="searchInput" name="search" placeholder="Search sections..."
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full border border-gray-200 divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap text-center space-x-2">
                                ...
                                <button class="text-red-600 hover:text-red-900 delete-btn" title="Delete"
                                    data-section-id="<?php echo $section['SectionID']; ?>" aria-label="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" class="px-4 py-2 text-center text-gray-500">No sections found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const addModal = document.getElementById('addNewSectionModal');
        ...
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (confirm('Are you sure you want to delete this section?')) {
                    ...
                    fetch('src/partials/dashboard_pages/admin/functions/func_sections.php', {
                        method: 'POST',
                        headers: {
                        ...
                        .catch(error => {
                            messageContainer.innerHTML = '<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">Error deleting section.</div>';
    ...
    // AJAX form submission for Add Section
    ...
    // AJAX form submission for Edit Section
