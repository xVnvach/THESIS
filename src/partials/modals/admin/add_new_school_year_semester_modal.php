...
<div id="addNewSchoolYearSemesterModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 border-b rounded-t">
                <h3 class="text-xl font-semibold text-gray-900">
                    Add New School Year Semester
                </h3>
                <button type="button"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                    data-modal-hide="addNewSchoolYearSemesterModal">
            ...
            <div class="p-6 space-y-6">
                <form id="addSchoolYearSemesterForm" method="POST"
                    action="src/partials/dashboard_pages/admin/functions/func_school_year_semester.php"
                    class="space-y-4">
                    <div class="flex space-x-2">
                        <div class="flex-1">
                            <label for="addStartYear" class="block text-gray-700 text-sm font-bold mb-2">
                                Start Year: <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="addStartYear" name="addStartYear" required
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                placeholder="e.g., 2023" pattern="^\d{4}$" title="Start year must be a 4-digit number.">
                        </div>
                        <div class="flex-1">
                            <label for="addEndYear" class="block text-gray-700 text-sm font-bold mb-2">
                                End Year: <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="addEndYear" name="addEndYear" required
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    <div>
                        ...
                        <select id="addSemester" name="addSemester" required
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="flex items-center space-x-2">
                        <input type="checkbox" id="addIsActive" name="addIsActive"
                            class="form-checkbox h-4 w-4 text-indigo-600">
                        <label for="addIsActive" class="text-gray-700 text-sm font-bold">Set as Active</label>
                    </div>
                ...
                <script>
                    document.getElementById('addSchoolYearSemesterForm').addEventListener('submit', function (event) {
                        const startYearInput = document.getElementById('addStartYear');
                        const endYearInput = document.getElementById('addEndYear');
