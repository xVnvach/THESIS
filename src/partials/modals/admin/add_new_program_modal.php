<div id="addNewProgramModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="addNewProgramModal">
...
<form method="POST" action="src/partials/dashboard_pages/admin/functions/func_programs.php" id="addProgramForm">
                    <div class="mb-4">
                        <label for="addProgramName" class="block text-gray-700 text-sm font-bold mb-2">
                            Program Name:
                            <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="addProgramName" id="addProgramName" required
