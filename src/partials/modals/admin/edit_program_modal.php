<div id="editProgramModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="editProgramModal">
            ...
            <div class="p-6 space-y-6">
                <form method="POST" action="" id="editProgramForm">
                    <input type="hidden" name="editProgramID" id="editProgramID" />
                    <div class="mb-4">
                        <label for="editProgramName" class="block text-gray-700 text-sm font-bold mb-2">
                            Program Name:
                            <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="editProgramName" id="editProgramName" required
